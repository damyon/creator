...
export interface InitOutput {
  ...
  readonly closure125_externref_shim_multivalue_shim: (a: number, b: number, c: any) => [number, number];
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h198385c8c22444e6: (a: number, b: number) => void;
  readonly closure155_externref_shim: (a: number, b: number, c: any) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hd79b42fd0b65d439: (a: number, b: number) => void;
